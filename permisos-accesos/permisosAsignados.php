...
<div class="container-fluid">
    ...
    <div class="row">   
        ...
        <div class="col-4">
            ...
            <div class="row"> 
                <div class="col-12">
                    <a href="#" class="btn btn-outline-info d-block disabled"><span class="badge badge-pill badge-info">Permisos autorizados</span></a>
                </div>
            </div>
            <br>
            <div class="row"> 
       ...
       <!--COLUMNA DOS FILA DOS-->
        <div class="col-8">
            <div><h1 class="text-center">Permisos asginados</h1>
                    </div>  
            <div class="row justify-content-center">
            ...
            <div class="card w-50">
                ...
                <div class="card-body bg-ligth">
                    <p>E - Mail : 1 <br> Monitor:  1 <br> Cloud : 1
                    <br> Allie- System : No</p>
                    <p>Ubiqo: 1 <br>
                        <p>Evidence: 1 <br>
