...
<div class="container-fluid">
    ...
    <div class="row">   
        ...
        <div class="col-4">
            ...
            <div class="row"> 
                <div class="col-12">
                    <a href="#" class="btn btn-outline-info d-block disabled"><span class="badge badge-pill badge-info">Mis herramientas</span></a>
                </div>
            </div>
            <br>
            <div class="row"> 
       ...
       <!--COLUMNA DOS FILA DOS-->
        <div class="col-8">
            <div><h1 class="text-center">Herramientas asignadas</h1>
                    </div>  
            <div class="row justify-content-center">
            ...
            <div class="card w-50">
                ...
                <div class="card-body bg-ligth">
                    <p>Playera : 1 <br> Monitor:  1 <br> Gorra : 1
                    <br> Chaleco : No
                    <br> Tabla : 1 
                    <br>Cuaderno: 1
                        <br>Credencial: 1 
                            <br>Cordón Credencial: 1
