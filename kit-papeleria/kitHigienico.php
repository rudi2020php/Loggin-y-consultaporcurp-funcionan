...
<div class="container-fluid">
    ...
    <div class="row">   
        ...
        <div class="col-4">
            ...
            <div class="row"> 
                <div class="col-12">
                    <a href="#" class="btn btn-outline-info d-block disabled"><span class="badge badge-pill badge-info">Kit higienico </span></a>
                </div>
            </div>
            <br>
            <div class="row"> 
       ...
       <!--COLUMNA DOS FILA DOS-->
        <div class="col-8">
            <div><h1 class="text-center">Kit de Higiene</h1>
                    </div>  
            <div class="row justify-content-center">
            ...
            <div class="card w-50">
                ...
                <div class="card-body bg-ligth">
                    <p>Cubre boca : 1 <br> Monitor:  1 <br> Careta : 1
                    <br> Gel antibacterial : No
                    <br> Bolsa Celular : 1                  
                </div>
 ...
 <a href="datosEmpleado.php?id=<?php echo $datos['curp']; ?>" class="btn btn-outline-warning"><span class="badge badge-pill badge-warning"> Ver...</span> </a>
 </div>
                </div>
            </div>
            </div>
